...
class CommentIntegrationTest(TestCase):
    ...
    def test_multiple_users_commenting(self):
        ...
        self.client.post(reverse('make_feed_comment', args=['12345']), comment1_data)
        ...
        self.client.post(reverse('make_feed_comment', args=['12345']), comment2_data)
        ...
        user1_comment = RecipeComment.objects.get(comment='Comment from user 1')
